...
#---------------------------------------------------------------------------------------
#---------------------------------------------------------------------------------------
from L_Archivos import *  # importar con los mismos nombres
...
def GET_ID( Mascara = 0): # mejorar por que podia pasa cualquiera
    MAC = Get_MAC()
    Caracte         = ((Leer_Linea(51, 1)).replace("\n","")).replace("\r","")
    Fecha_Init      = ((Leer_Linea(51, 2)).replace("\n","")).replace("\r","")
    Consecutivo     = ((Leer_Linea(51, 3)).replace("\n","")).replace("\r","")
